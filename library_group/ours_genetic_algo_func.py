...
def genetic_algorithm(
    ...
    generation_best_scores_df = pd.DataFrame(columns=['Generation', 'Fitness'], index=[i for i in range(max_gen)])
    ...
    for gen in range(1, max_gen + 1):
        ...
        generation_best_scores_df.iloc[gen-1, 1] = get_best_ind(population, maximization).fitness()
